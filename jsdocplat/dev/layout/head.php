...
<html>
    <head>
        ...
        <script type="text/javascript" src="http://a.tbcdn.cn/??s/kissy/1.1.7/kissy-min.js">
        </script>
        <script type="text/javascript" src="assets/jsdocplat.js">
        </script>
		<script type="text/javascript" src="http://a.tbcdn.cn/??s/yui/3.3.0/build/yui/yui-min.js"></script>
        <script type="text/javascript" src="assets/jsdocYUI.js">
        </script>
